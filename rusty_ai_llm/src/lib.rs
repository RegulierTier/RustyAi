...
//! **FIM:** [`forward_fim`](MiniGpt::forward_fim), [`fim_middle_prediction_positions`], and
...
pub use attention::{attention_single_query, attention_with_additive_mask, causal_attention};
...
pub use fim::{fim_additive_mask, fim_allowed, fim_middle_prediction_positions};
