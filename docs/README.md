...
| **[`../rusty_ai/README.md`](../rusty_ai/README.md)** | Meta-Crate **`rusty_ai`**: Re-Exports, Features (`candle`, `hf-hub`, `gpt2-bpe`), Verweise auf Handbuch und Root-README. |
